...
47 specimens, 203 evidence rows (170 claims + 33 niceties), 62 of them unverified (31%),
12 warnings. Topology split: graph 29 · rack 7 · matrix 2 · code 5 · format 4.
...
`tools/render-test.mjs` hard-codes the expected specimen count (`47`, twice — once directly and
once as `47 * 4` for the facet badges). Adding or removing a specimen means updating both.
