...
48 specimens, 209 evidence rows (176 claims + 33 niceties), 65 of them unverified (31%),
12 warnings. Topology split: graph 30 · rack 7 · matrix 2 · code 5 · format 4.
...
`tools/render-test.mjs` hard-codes the expected specimen count (`48`, twice — once directly and
once as `48 * 4` for the facet badges). Adding or removing a specimen means updating both.
